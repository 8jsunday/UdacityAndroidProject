...
public class WeatherProvider extends ContentProvider {
	...
	private static final UriMatcher sUriMatcher = buiUriMatcher();

	private WeatherDbHelper mOpenHelper;

	private static final SQLiteQueryBuilder sWeatherByLocationSettingQueryBulder;

	static {
		sWeatherByLocationSettingQueryBulder = new SQLiteQueryBuilder();
		sWeatherByLocationSettingQueryBulder
	...
	private static final String sLocationSettingSelecton = WeatherContract.LocationEntry.TABLE_NAME
			+ "."
	...
	private static UriMatcher buiUriMatcher() {
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case WEATHER_WITH_LOCATION_AND_DATE: {
			retCursor = getWeatherByLocationSettingWithDate(uri, projection,
					sortOrder);
			break;
		}
	...
	private Cursor getWeatherByLocationSetting(Uri uri, String[] projection,
		...
		if (startDate == null) {
			selection = sLocationSettingSelecton;
		...
		return sWeatherByLocationSettingQueryBulder.query(
	...
	private Cursor getWeatherByLocationSettingWithDate(Uri uri,
		...
		String locationString = WeatherContract.WeatherEntry
				.getLocationSettingFromUri(uri);
		...
		return sWeatherByLocationSettingQueryBulder.query(
				...
				sLocationSettingWithDaySelection, new String[] {
						locationString, date }, null, null, sortOrder);
	}
